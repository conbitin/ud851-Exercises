...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenWebpageButton(View v) {
        ...
        String webURL = "https://developer.android.com/";
    ...
    void openWebpage(String uriString) {
        ...
        Intent intentOpenWebpage = new Intent();
        intentOpenWebpage.setAction(Intent.ACTION_VIEW);
        intentOpenWebpage.setData(uri);
