...
public class SettingsFragment extends PreferenceFragmentCompat implements
    ...
    public void onCreatePreferences(Bundle bundle, String s) {
        ...
        EditTextPreference preference = (EditTextPreference) findPreference(getString(R.string.pref_size_key));
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        try {
            ...
            if (size <= 0 || size > 3) {
                Toast.makeText(getActivity(),"The value must be a numeric from 0 (exclusive) to 3 (inclusive)", Toast.LENGTH_SHORT).show();
                return false;
            }
            return true;
